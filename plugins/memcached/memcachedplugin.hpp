...
extern "C++"
{
    ...
    ECL_MEMCACHED_API bool ECL_MEMCACHED_CALL MSet(ICodeContext * _ctx, const char * servers, const char * key, signed char value, const char * partitionKey, unsigned expire);
    ECL_MEMCACHED_API bool ECL_MEMCACHED_CALL MSet(ICodeContext * _ctx, const char * servers, const char * key, signed short value, const char * partitionKey, unsigned expire);
    ECL_MEMCACHED_API bool ECL_MEMCACHED_CALL MSet(ICodeContext * _ctx, const char * servers, const char * key, signed int value, const char * partitionKey, unsigned expire);
    ...
    ECL_MEMCACHED_API bool ECL_MEMCACHED_CALL MSet(ICodeContext * _ctx, const char * servers, const char * key, unsigned char value, const char * partitionKey, unsigned expire);
    ECL_MEMCACHED_API bool ECL_MEMCACHED_CALL MSet(ICodeContext * _ctx, const char * servers, const char * key, unsigned short value, const char * partitionKey, unsigned expire);
    ECL_MEMCACHED_API bool ECL_MEMCACHED_CALL MSet(ICodeContext * _ctx, const char * servers, const char * key, unsigned int value, const char * partitionKey, unsigned expire);
    ...
    ECL_MEMCACHED_API bool ECL_MEMCACHED_CALL MSet(ICodeContext * _ctx, const char * servers, const char * key, char * value, const char * partitionKey, unsigned expire);
    ECL_MEMCACHED_API bool ECL_MEMCACHED_CALL MSet(ICodeContext * _ctx, const char * servers, const char * key, float value, const char * partitionKey, unsigned expire);
    ECL_MEMCACHED_API bool ECL_MEMCACHED_CALL MSet(ICodeContext * _ctx, const char * servers, const char * key, UChar * value, const char * partitionKey, unsigned expire);
    ...
    ECL_MEMCACHED_API bool ECL_MEMCACHED_CALL MSetVoidPtr(ICodeContext * _ctx, const char * servers, const char * key, size32_t len, void * value, const char * partitionKey, unsigned expire);
    ECL_MEMCACHED_API bool ECL_MEMCACHED_CALL MSet(ICodeContext * _ctx, const char * servers, const char * key, size32_t valueLength, char * value, const char * partitionKey, unsigned expire);
    ECL_MEMCACHED_API bool ECL_MEMCACHED_CALL MSet(ICodeContext * _ctx, const char * servers, const char * key, size32_t valueLength, UChar * value, const char * partitionKey, unsigned expire);
    //--------------------------GET----------------------------------------
