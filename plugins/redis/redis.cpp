...
static bool connectionCachingLevelChecked = false;
...
#else
const static Connection * cachedConnection = nullptr;
const static Connection * cachedPubConnection = nullptr;//database should always = 0
#endif
