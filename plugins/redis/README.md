...
anticipated latency of the client-server-IO, where such multiple should be at least the maximum number of internal redis calls made by these plugin functions, i.e. 12.
...
This is such that the lock doesn't out live all waiting subscribers that collectively timeout and thus not block any subsequent retries of the locking pattern.
