...
namespace RedisPlugin {
    ...
    ECL_REDIS_API unsigned __int64 ECL_REDIS_CALL SyncRPub(ICodeContext * _ctx, const char * keyOrChannel, size32_t messageLength, const char * message, const char * options, const char * pswd, unsigned timeout, bool lockedKey);
    ECL_REDIS_API void ECL_REDIS_CALL SyncRSub(ICodeContext * _ctx, size32_t & messageLength, char * & message, const char * keyOrChannel, const char * options, const char * pswd, unsigned timeout, bool lockedKey);
